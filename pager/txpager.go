...
// TxPager wraps a *Pager and buffers all page writes in memory until Flush is called.
//
...
//   For Phase 4 this is acceptable; a buffer-pool with LRU eviction is Phase 6.
//
...
func NewTxPager(base *Pager) *TxPager {
